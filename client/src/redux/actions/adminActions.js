...
export const getVoteList = () => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/admin/vote`, config)
...
export const getContactList = () => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/admin/contact`, config)
...
export const getContactDetails = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/admin/contact/${id}`, config)
...
export const deleteContact = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        await axios.delete(`http://localhost:5000/api/admin/contact/del/${id}`, config)
...
export const getAdminList = () => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/admin/all`, config)
...
export const getAdminDetails = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/admin/all/${id}`, config)
...
export const getVoteLocation = (val) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.post(`http://localhost:5000/api/analysis/oneLocation`, val, config)
...
export const getVoteLocationGender = (val) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.post(`http://localhost:5000/api/analysis/oneLocationGender`, val, config)
