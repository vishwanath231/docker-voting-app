...
const AnalysisScreen = ({ voteDistrict, getVoteLocation, getVoteLocationGender, voteDistrictGender }) => {
    ...
    // VOTE ANALYSIS
    useEffect(() => {
        axios.get(`http://localhost:5000/api/analysis/voteCount`)
        .then((res) => {
   ...
   // HAND GENDER ANALYSIS
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/analysis/handGender`)
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/analysis/leafGender`)
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/analysis/userGender`)
        .then((res) => {
   ...
   // USER LOCATION ANALYSIS
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/analysis/userLocation`)
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/analysis/voteGender`)
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/analysis/voteLocation`)
        .then((res) => {
        ...
        <div className='bg-gray-100 min-h-screen'>
            ...
            <div className='md:ml-72 px-4'>
                <div>
                    ...
                    {userVoteError && <Message error msg={userVoteError} />}
